...
```{r}
ggplot(Paisley, aes(x = af, y = rainfall, color = half_year)) +
  geom_point() +
  labs(x = "af", y = "Rainfall", color = "half_year") +
  geom_smooth(method = "lm", se = FALSE)

ggplot(Paisley, aes(x = sun, y = rainfall, color = half_year)) +
  geom_point() +
  labs(x = "sun", y = "Rainfall", color = "half_year") +
  geom_smooth(method = "lm", se = FALSE)
```
...
ggplot(regression.points, aes(x = af, y = residual)) +
  geom_point() +
  labs(x = "af(days)", y = "Residual", title = "Residuals vs af")  +
  geom_hline(yintercept = 0, col = "blue", size = 1)+
  facet_wrap(~ half_year)

ggplot(regression.points, aes(x = sun, y = residual)) +
  geom_point() +
  labs(x = "sun(hours)", y = "Residual", title = "Residuals vs sun")  +
  geom_hline(yintercept = 0, col = "blue", size = 1)+
  facet_wrap(~ half_year)
```
